#include "com_movlad_pcl_io_PointCloud3dReader.h"
...
void Java_com_movlad_pcl_io_PointCloud3dReader_readPCD(JNIEnv *env, jobject obj, jstring file_name, jobject cloud)
{
...
void Java_com_movlad_pcl_io_PointCloud3dReader_readPLY(JNIEnv *env, jobject obj, jstring file_name, jobject cloud)
{
	pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud_ptr = sptr_wrapper<pcl::PointCloud<pcl::PointXYZRGB>>::get_sptr(env, cloud);
	const char *native_file_name = env->GetStringUTFChars(file_name, JNI_FALSE);
