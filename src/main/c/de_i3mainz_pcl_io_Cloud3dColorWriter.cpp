#include "de_i3mainz_pcl_io_Cloud3dColorWriter.h"
...
void Java_de_i3mainz_pcl_io_Cloud3dColorWriter_writePCD
...
void Java_de_i3mainz_pcl_io_Cloud3dColorWriter_writePLY
(JNIEnv *env, jobject obj, jstring file_name, jobject cloud, jboolean binary_mode)
{
	pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud_ptr
		= sptr_wrapper<pcl::PointCloud<pcl::PointXYZRGB>>::get_sptr(env, cloud);
