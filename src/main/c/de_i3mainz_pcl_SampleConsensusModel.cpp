#include "de_i3mainz_pcl_SampleConsensusModel.h"
...
void Java_de_i3mainz_pcl_SampleConsensusModel_setInputCloud
...
jint Java_de_i3mainz_pcl_SampleConsensusModel_getSampleSize
...
jdouble Java_de_i3mainz_pcl_SampleConsensusModel_computeVariance
(JNIEnv *env, jobject obj)
{
	pcl::SampleConsensusModel<pcl::PointXYZRGB>::Ptr scm_ptr =
		sptr_wrapper<pcl::SampleConsensusModel<pcl::PointXYZRGB>>::get_sptr(env, obj);
