#include "de_i3mainz_pcl_SampleConsensusModelCylinder.h"
#include "sptr_wrapper.h"

#include <pcl/sample_consensus/sac_model_cylinder.h>

void Java_de_i3mainz_pcl_SampleConsensusModelCylinder_alloc
...
void Java_de_i3mainz_pcl_SampleConsensusModelCylinder_dispose
(JNIEnv *env, jobject obj)
{
	sptr_wrapper<pcl::SampleConsensusModel<pcl::PointXYZRGB>>::dispose(env, obj);
}

jdouble Java_de_i3mainz_pcl_SampleConsensusModelCylinder_getNormalDistanceWeight
(JNIEnv *env, jobject obj)
{
...
void Java_de_i3mainz_pcl_SampleConsensusModelCylinder_setNormalDistanceWeight
...
void Java_de_i3mainz_pcl_SampleConsensusModelCylinder_nGetInputNormals
...
void Java_de_i3mainz_pcl_SampleConsensusModelCylinder_setInputNormals
(JNIEnv *env, jobject obj, jobject normals)
{
	pcl::SampleConsensusModelCylinder<pcl::PointXYZRGB, pcl::Normal>::Ptr saccyl_ptr =
		sptr_wrapper<pcl::SampleConsensusModelCylinder<pcl::PointXYZRGB, pcl::Normal>>::get_sptr(env, obj);
