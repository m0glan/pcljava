#include "de_i3mainz_pcl_SampleConsensus.h"
#include "handle.h"
...
void Java_de_i3mainz_pcl_SampleConsensus_nSetSampleConsensusModel
...
jdouble Java_de_i3mainz_pcl_SampleConsensus_getDistanceThreshold
...
void Java_de_i3mainz_pcl_SampleConsensus_setDistanceThreshold
...
jint Java_de_i3mainz_pcl_SampleConsensus_getMaxIterations
(JNIEnv *env, jobject obj)
{
	pcl::SampleConsensus<pcl::PointXYZRGB>::Ptr sac_ptr =
		sptr_wrapper<pcl::SampleConsensus<pcl::PointXYZRGB>>::get_sptr(env, obj);
...
void Java_de_i3mainz_pcl_SampleConsensus_setMaxIterations
...
jdouble Java_de_i3mainz_pcl_SampleConsensus_getProbability
(JNIEnv *env, jobject obj)
{
	pcl::SampleConsensus<pcl::PointXYZRGB>::Ptr sac_ptr =
		sptr_wrapper<pcl::SampleConsensus<pcl::PointXYZRGB>>::get_sptr(env, obj);
...
void Java_de_i3mainz_pcl_SampleConsensus_setProbability
...
jboolean Java_de_i3mainz_pcl_SampleConsensus_refineModel
...
void Java_de_i3mainz_pcl_SampleConsensus_nGetInliners
