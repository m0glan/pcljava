#include "de_i3mainz_pcl_SampleConsensusModelCone.h"
#include "sptr_wrapper.h"

#include <pcl/sample_consensus/sac_model_cone.h>

void Java_de_i3mainz_pcl_SampleConsensusModelCone_alloc
...
void Java_de_i3mainz_pcl_SampleConsensusModelCone_dispose
(JNIEnv *env, jobject obj)
{
	sptr_wrapper<pcl::SampleConsensusModel<pcl::PointXYZRGB>>::dispose(env, obj);
}

jdouble Java_de_i3mainz_pcl_SampleConsensusModelCone_getNormalDistanceWeight
(JNIEnv *env, jobject obj)
{
...
void Java_de_i3mainz_pcl_SampleConsensusModelCone_setNormalDistanceWeight
...
void Java_de_i3mainz_pcl_SampleConsensusModelCone_nGetInputNormals
...
void Java_de_i3mainz_pcl_SampleConsensusModelCone_setInputNormals
(JNIEnv *env, jobject obj, jobject normals)
{
	pcl::SampleConsensusModelCone<pcl::PointXYZRGB, pcl::Normal>::Ptr saccone_ptr =
		sptr_wrapper<pcl::SampleConsensusModelCone<pcl::PointXYZRGB, pcl::Normal>>::get_sptr(env, obj);
