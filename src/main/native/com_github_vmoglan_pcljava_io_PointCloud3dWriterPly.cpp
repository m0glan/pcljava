#include "com_github_vmoglan_pcljava_io_PointCloud3dWriterPly.h"
...
void Java_com_github_vmoglan_pcljava_io_PointCloud3dWriterPly_write(JNIEnv *env, jobject obj, jobject cloudJava, jstring fileName, jboolean binaryMode)
{
