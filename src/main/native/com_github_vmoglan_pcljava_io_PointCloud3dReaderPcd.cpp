#include "com_github_vmoglan_pcljava_io_PointCloud3dReaderPcd.h"
...
void Java_com_github_vmoglan_pcljava_io_PointCloud3dReaderPcd_read(JNIEnv *env, jobject obj, jstring fileName, jobject cloudJava)
{
