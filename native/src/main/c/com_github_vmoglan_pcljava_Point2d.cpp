#include "com_github_vmoglan_pcljava_Point2d.h"
...
jfloat Java_com_github_vmoglan_pcljava_Point2d_getX(JNIEnv *env, jobject obj) 
{
	return getHandle<pcl::PointXY>(env, obj)->x;
}

void Java_com_github_vmoglan_pcljava_Point2d_setX(JNIEnv *env, jobject obj, jfloat x)
{
	getHandle<pcl::PointXY>(env, obj)->x = x;
}

jfloat Java_com_github_vmoglan_pcljava_Point2d_getY(JNIEnv *env, jobject obj)
{
	return getHandle<pcl::PointXY>(env, obj)->y;
}

void Java_com_github_vmoglan_pcljava_Point2d_setY(JNIEnv *env, jobject obj, jfloat y)
{
