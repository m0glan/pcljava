...
void Java_io_github_vmoglan_pcljava_SampleConsensusModelLine_alloc(JNIEnv *, jobject obj)
{
...
void Java_io_github_vmoglan_pcljava_SampleConsensusModelLine_dispose(JNIEnv *, jobject obj)
{
