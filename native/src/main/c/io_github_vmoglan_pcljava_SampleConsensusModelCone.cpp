...
void Java_io_github_vmoglan_pcljava_SampleConsensusModelCone_alloc(JNIEnv *env, jobject obj)
{
	PointCloud::Ptr cloud(new PointCloud());
	auto wrapper = new SharedPointerWrapper<SampleConsensusModelCone>(cloud);
}

void Java_io_github_vmoglan_pcljava_SampleConsensusModelCone_dispose(JNIEnv *env, jobject obj)
{
	SharedPointerWrapper<SampleConsensusModelCone>::dispose(env, obj);
}

jdouble Java_io_github_vmoglan_pcljava_SampleConsensusModelCone_getNormalDistanceWeight(JNIEnv *env, jobject obj)
{
...
void Java_io_github_vmoglan_pcljava_SampleConsensusModelCone_setNormalDistanceWeight(JNIEnv *env, jobject obj, jdouble weight)
{
	auto model = SharedPointerWrapper<SampleConsensusModelCone>::getPointer(env, obj);
...
void Java_io_github_vmoglan_pcljava_SampleConsensusModelCone_nGetInputNormals(JNIEnv *env, jobject obj, jobject normalsJava)
{
	auto model = SharedPointerWrapper<SampleConsensusModelCone>::getPointer(env, obj);
...
void Java_io_github_vmoglan_pcljava_SampleConsensusModelCone_setInputNormals(JNIEnv *env, jobject obj, jobject normalsJava)
{
	auto model = SharedPointerWrapper<SampleConsensusModelCone>::getPointer(env, obj);
